...
function generateQuestions(index,answer){
  var newScore = parseInt(sessionStorage.getItem("Score"));
  console.log(score);
  if(answer === 0){
    score += questions[index].answer1Total;
    console.log(score);
    sessionStorage.setItem("Score", newScore+parseInt(questions[index].answer1Total));
    
  }
  if(answer === 1){
    score += questions[index].answer2Total;
    console.log(score);
    sessionStorage.setItem("Score", newScore+parseInt(questions[index].answer2Total));
    
  }
  if(answer === 2){
    score += questions[index].answer3Total;
    console.log(score);
    sessionStorage.setItem("Score", newScore+parseInt(questions[index].answer3Total));
    
  }
  if(answer === 3){
    score += questions[index].answer4Total;
    console.log(score)
    sessionStorage.setItem("Score", newScore+parseInt(questions[index].answer4Total));
    
  }
window.location.replace('question' + (index+2) + '.html');
